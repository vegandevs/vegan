              ...
              correlation = FALSE, ...) 
{
    ...
    ## process scaling arg, this will ignore hill if scaling = FALSE
    ## or a numeric.  scaling also used later so needs to be a numeric
    ## (or something coercible to one (FALSE)
