...
point, and the tries to find a position that minimizes over-writing
other labels. This is impossible in very congested areas, but often
helps in moderate cases. Argument `bg` defines a background colour of
...
you to edit the plotted text, and `select` to drop completely some
cases.
