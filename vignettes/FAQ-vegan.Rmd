...
take precedence over **vegan**. Sometimes **vegan** namespace can be
loaded automatically when restoring the previously stored workspace at
...
is to remove one of the packages if only possible. See discussion in
