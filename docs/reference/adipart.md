...
#> alpha.1    15.114 -48.725 22.332 22.099 22.329 22.536     0.05 *
#> gamma      35.000   0.000 35.000 35.000 35.000 35.000     1.00  
#> beta.1     19.886  48.725 12.668 12.464 12.671 12.901     0.05 *
#> ---
...
#> 
#>         statistic      SES     mean     2.5%      50%  97.5% Pr(sim.)  
#> alpha.1    15.114 -47.3389 22.35263 22.07000 22.34286 22.607     0.05 *
#> alpha.2    29.750 -17.8182 34.80263 34.22500 35.00000 35.000     0.05 *
#> alpha.3    33.000   0.0000 35.00000 35.00000 35.00000 35.000     0.05 *
#> gamma      35.000   0.0000 35.00000 35.00000 35.00000 35.000     1.00  
#> beta.1     14.636   6.1598 12.45000 11.75643 12.47143 12.930     0.05 *
#> beta.2      3.250  10.7652  0.19737  0.00000  0.00000  0.775     0.05 *
...
#> 
#>         statistic      SES     mean     2.5%      50%   97.5% Pr(sim.)  
#> alpha.1    15.114 -39.0520 22.36692 22.15143 22.31429 22.7871     0.05 *
#> alpha.2    29.750 -33.9040 34.89474 34.61250 35.00000 35.0000     0.05 *
#> alpha.3    33.000   0.0000 35.00000 35.00000 35.00000 35.0000     0.05 *
#> gamma      35.000   0.0000 35.00000 35.00000 35.00000 35.0000     1.00  
#> beta.1     14.636   7.2424 12.52782 11.96286 12.67143 12.8421     0.05 *
#> beta.2      3.250  20.7239  0.10526  0.00000  0.00000  0.3875     0.05 *
...
#> 
#>         statistic     SES    mean    2.5%     50%  97.5% Pr(sim.)  
#> level_1   0.76064 -72.356 0.93929 0.93465 0.93932 0.9434     0.05 *
...
#> 
#>      statistic      SES    mean    2.5%     50%  97.5% Pr(sim.)  
#> unit   0.76064  -62.616 0.93935 0.93448 0.93917 0.9435     0.05 *
#> l2     0.89736 -126.338 0.99804 0.99636 0.99828 0.9991     0.05 *
#> l3     0.92791 -584.895 0.99934 0.99910 0.99935 0.9995     0.05 *
...
#> 
#>    statistic     SES     mean     2.5%      50%   97.5% Pr(sim.)  
#> l1   0.52070  5.6798  0.35192  0.29670  0.35670  0.3977     0.05 *
#> l2   0.60234 18.4192  0.17303  0.12833  0.17657  0.2071     0.05 *
#> l3   0.67509 25.1696 -0.18818 -0.24786 -0.19179 -0.1290     0.05 *
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
